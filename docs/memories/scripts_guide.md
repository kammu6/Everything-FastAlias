...
### tests/extensions/
- [chk_hardcoded_extensions.py](file:///D:/3_Code/3_Apps/43_Search-Edit/Everything검색기/scripts/tests/extensions/chk_hardcoded_extensions.py): `🟢 [Read-Only]` Scans the src directory for hardcoded file extensions and media preset mappings.
<!-- END_LIST -->
